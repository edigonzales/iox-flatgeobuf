...
public class FlatGeobufWriterTest {
    
    private static final String TEST_IN="src/test/data/FlatGeobufWriter/";
    private final static String TEST_OUT="build/test/data/FlatGeobufWriter";
